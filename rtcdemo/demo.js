var Demo = (function () {
    ...
    $.connection.hub.url = 'https://localhost:44360/signalr/hubs';
   ...
   async function closingCode() {
    ...
    async function _createOffer() {
        ...
        hub.server.send(JSON.stringify({ 'offer': connection.localDescription }) ,"_createOffer");
    }
    
	async function Reloadpage() {
        //Send offer to Server//
        hub.server.send(JSON.stringify({ 'offer': connection.localDescription }) ,"Reload");
    }
    function timerstart(){
